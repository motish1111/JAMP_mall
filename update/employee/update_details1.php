...
$sql="SELECT password FROM login_details WHERE employee_id='".$_POST['eid']."';";
//echo $sql;
$result=mysqli_query($conn,$sql);
$r=mysqli_fetch_array($result);
$password=$r['password'];

$sql="SELECT CONCAT(fname, ' ', mname, ' ', lname) AS sup FROM employee_details where id='".$row['supervisor']."';";
//echo $sql;
$result=mysqli_query($conn,$sql);
//echo $sql;
$r=mysqli_fetch_array($result);
...
$sql="SELECT name,department FROM stores WHERE id='".$row['store_id']."';";
$result=mysqli_query($conn,$sql);
$r=mysqli_fetch_array($result);
    ...
    <body>
        <div class="employee_details_form">
            ...
            <form id='form1' action="" method="post" hidden>
                <input type="text" id="dept" name="dept" placeholder="dept" value="<?php echo $department ?>">
                <input type="text" id="ttl" name="ttl" placeholder="ttl" value="<?php echo $row['title'] ?>">
                <input type="text" id="str" name="str" placeholder="str" value="<?php echo $store ?>">
                <input type="text" id="cstr" name="cstr" placeholder="cstr" value="<?php echo $store?>">
                <input type="ogttl" id="ogttl" name="ogttl" placeholder="ogttl" value="<?php echo $row['title']?>">
                <input type="ogdept" id="ogdept" name="ogdept" placeholder="ogdept" value="<?php echo $department?>">
                <input type="submit" id="submit">
            </form>
            <!----------------------------------------------------------------------------->        
            <form id="main_form" name="form" action="update.php" method="post">
                <input type="text" id="oldid" name="oldid" placeholder="oldid" value="<?php echo $_POST['eid']?>" hidden>
                <div class="page_content" id="page-1" name="PersonalInformation">
                    <fieldset class="name">
                        ...
                        <input type="text" name="firstname" onclick="document.getElementById('span1').style.display='none'" onkeypress="document.getElementById('span1').style.display='none'" oninput="this.value=this.value.toUpperCase()" placeholder="First" required style="width: 33%;" value="<?php echo $row['fname']?>";>
                        <input type="text" name="middlename" oninput="this.value=this.value.toUpperCase()" placeholder="Middle" style="width: 33%" value="<?php echo $row['mname']?>";>
                        <input type="text" name="lastname" onclick="document.getElementById('span1.1').style.display='none'" onkeypress="document.getElementById('span1.1').style.display='none'" oninput="this.value=this.value.toUpperCase()" placeholder="Last" style="width: 32.5%" value="<?php echo $row['lname']?>";>
                    ...
                    <fieldset style="margin-top: 10px;" class=address>
                        ...
                        <input type="text" name="address" onclick="document.getElementById('span2').style.display='none'" onkeypress="document.getElementById('span2').style.display='none'" oninput="this.value=this.value.toUpperCase()" placeholder="Address" required style="width: 100%; margin-bottom: 5px" value="<?php echo $row['address']?>";>
                        <input type="text" name="city" onclick="document.getElementById('span2').style.display='none'" onkeypress="document.getElementById('span2').style.display='none'" oninput="this.value=this.value.toUpperCase()" placeholder="City" required style="width: 49.7%; margin-bottom: 5px" value="<?php echo $row['city']?>";>
                        <input type="text" name="state" onclick="document.getElementById('span2').style.display='none'" onkeypress="document.getElementById('span2').style.display='none'" oninput="this.value=this.value.toUpperCase()" placeholder="State" required style="width: 49.7%" value="<?php echo $row['state']?>";>
                    ...
                    <fieldset style="margin-top: 10px;" class=email>
                        ...
                        <input type="text" name="email" style="width: 49.7%" oninput="this.value=this.value.toUpperCase()" value="<?php echo $row['email']?>";>
                    </fieldset>
                ...
                <div class="page_content" id="page-2" name="JobInformation">
                    ...
                    <fieldset class=title style="margin-top: 10px;">
                        ...
                        <input type="text" style="width: 50%; cursor: not-allowed" name="title" id="title" readonly="readonly" value="<?php echo $row['title']?>";>
<!--
                        <select readonly="readonly" name=title id="title" onclick="document.getElementById('span5').style.display='none'" onkeypress="document.getElementById('span5').style.display='none'" onchange="document.getElementById('span5').style.display='none'" style="width: 50%;">
                            <option></option>
...
-->
                    ...
                    <?php
    if($row['title']=='Store Manager')
    {
                    ?>
                    <fieldset style="margin-top: 10px;" class="password">
                        <legend><strong>Password</strong><strong style="color: red;">*</strong></legend>
                        <input type="text" style="width: 50%" name="password" id="password" value="<?php echo $password?>";>
                    </fieldset>
                    <?php
    }
                    ?>
                    <fieldset style="margin-top: 10px;" class=department>
                        ...
                        <select name=store id="store" onclick="document.getElementById('span6').style.display='none'" onkeypress="document.getElementById('span6').style.display='none'" style="width: 50%;" onchange="generate_eid()">
                            <option value="--">--</option>
                        </select>
                        <span id="span6" style="display:none"><br>Please select Store</span>
                    </fieldset>

                    <fieldset style="margin-top: 10px;" class="Supervisor">
                        <legend><strong>Supervisor</strong><a style="color: red"><strong>*</strong></a></legend>
                        <input type="text" style="width: 50%; cursor: not-allowed" name="supervisor" id="supervisor" readonly="readonly" value="<?php echo $supervisor?>";>
                    </fieldset>
                    ...
                    <fieldset style="margin-top: 10px;" class=salary>
                        ...
                        <input type="text" name="salary" onclick="document.getElementById('span8').style.display='none'" onkeypress="document.getElementById('span8').style.display='none'" style="width: 50%" value="<?php echo $row['salary']?>"
                               >
                ...
                <div class="page_content" id="page-3" name="Emergency">
                    <fieldset class=Name>
                        ...
                        <input type="text" name="ecdlastname" onclick="document.getElementById('span9.1').style.display='none'" onkeypress="document.getElementById('span9.1').style.display='none'" placeholder="Last" style="width: 32.5%" value="<?php echo $row['ecd_lname'] ?>">
                    ...
                    <input type="submit" class="btn" value="submit" id="main_submit" onclick="if(validateEmergency())update()">
                </div>
...
*/
            ...
            function validateJobInformation(){
                ...
                else if(title.vaue=="Store Manager" && pswd.value=="")
                {
                    document.getElementById('span5').style.display='';
                    pswd.focus();
                }
            ...
            $(document).on('change', '#title, #store', function(){
                ...
                var og="<?php echo $row['title']?>";
                if(og!='Store Manager')
                {

                    if(document.getElementById('title').value=='Store Manager')
                    {
                        document.getElementById('supervisor').value="<?php 
    echo $name;
                            ?>";
...
//            }
            ...
            //             select_store()
            {
                ...
                var store=document.getElementById('cstr').value;
                var d=document.getElementById("store");

                for(var i=0; i<d.length; i++)
                {
                    if(d.options[i].value==store)
                    {
                        d.value=d.options[i].value;
                    }
                }
